...
public class FieldOfView : MonoBehaviour
{
	...
	void FieldOfViewCheck()
	{
		...
		{
			// If transform.position instead of eyes.position is used as the ray origin, it goes through the ground.
			// If the eye height isn't added to the target position, the ray will angle too steeply towards the ground.
