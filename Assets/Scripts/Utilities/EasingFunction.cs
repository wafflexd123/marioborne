...
public static class EasingFunction
{
	...
	static readonly Func<float, float> AnimationCurve = (float percent) => { Debug.LogWarning("EasingFunction: Attemped to use animation curve as easing function; defaulting to Linear"); return percent; };

	public enum Enum { Linear, EaseInSine, EaseOutSine, EaseInOutSine, EaseInCubic, EaseOutCubic, EaseInOutCubic, EaseInBounce, EaseOutBounce, EaseInOutBounce, EaseInExpo, EaseOutExpo, EaseInOutExpo, AnimationCurve }
	static readonly Func<float, float>[] array = { Linear, EaseInSine, EaseOutSine, EaseInOutSine, EaseInCubic, EaseOutCubic, EaseInOutCubic, EaseInBounce, EaseOutBounce, EaseInOutBounce, EaseInExpo, EaseOutExpo, EaseInOutExpo, AnimationCurve };
